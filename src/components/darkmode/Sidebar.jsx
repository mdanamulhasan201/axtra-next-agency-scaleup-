...
const Sidebar = () => {
    ...
    return (
        <div className={`fixed inset-0 flex items-center justify-end z-50 ${isDarkMode ? 'bg-dark text-white' : 'bg-light text-black'}`}>
            ...
            >
                <FaCog
                    className={`text-2xl animate-spinSlow hover:text-[#777777] transition-colors duration-300`}
                />
            </button>
            ...
            >
                ...
                <div className="p-5">
                    ...
                    <select className={`w-full mt-2 p-2 rounded ${isDarkMode ? 'bg-[#2b2b2f] text-white' : 'bg-gray-200 text-black'}`}>
                    ...
                    <div className="flex mt-2 space-x-2">
                        <button
                            ...
                            className={`p-2 w-full text-sm font-semibold rounded ${!isDarkMode ? 'bg-[#2b2b2f] text-white' : 'bg-[#2b2b2f] text-gray-400 hover:text-white transform duration-300'}`}
                        >
                            Light
                        </button>
                        <button
